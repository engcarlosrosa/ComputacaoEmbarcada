...
/************************************************************************/
 ...
 static xdmac_channel_config_t g_xdmac_tx_cfg;	//Structure com definições de configuração para o DMA
...
uint8_t g_rx_buffer[BUFFER_SIZE] = "0";			//Vetor alocado em memória para recebimento dos dados transferidos via DMA do periférico USART1
uint32_t g_buffer_size = sizeof(g_tx_buffer);	//: tamanho em bytes, do vetor de transmissão
/************************************************************************/
/* Flags */
/************************************************************************/
volatile uint8_t flag_led0 = 1;				//flag com o status do led
volatile uint8_t flag_rx = 0;				 //irá indicar que o DMA de recepção foi finalizado
